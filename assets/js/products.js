...
const CATEGORIES = [
  {
    ...
    tier: 'Premium Finish',
    desc: 'Custom epoxy magnets and crystal dome refrigerator magnets for premium souvenir, gift and branded retail collections.',
    seoTitle: 'Custom Epoxy Magnets | Crystal Dome Refrigerator Magnets',
    seoDescription: 'Source custom epoxy magnets and crystal dome refrigerator magnets for Epoxy Resin Magnet Wholesale programs. Request custom artwork and fast lead time.',
    seoH1: 'Custom Epoxy & Crystal Magnets',
    count: 4,
    color: 'c-orange'
  },
  {
    ...
    desc: 'Custom printed flexible magnets, magnetic vehicle signs and rubber magnet media for promotions, branding and retail programs.',
    seoTitle: 'Custom Printed Flexible Magnets | Magnetic Vehicle Signs',
    seoDescription: 'Buy Custom Printed Flexible Magnets and Magnetic Vehicle Signs from a Rubber Magnet Printing Factory. Request factory customization and fast lead time.',
    seoH1: 'Custom Printed Flexible Magnets & Vehicle Signs',
    count: 3,
    color: 'c-coffee'
  },
  {
    ...
    tier: 'Premium Finish',
    desc: 'Custom acrylic fridge magnets and acrylic photo frame magnets for premium souvenir, gift and branded retail collections.',
    seoTitle: 'Custom Acrylic Fridge Magnets | Acrylic Photo Frame Magnets',
    seoDescription: 'Work with an Acrylic Photo Frame Magnets Supplier for Custom Acrylic Fridge Magnets, artwork and shapes. Request a factory-direct quote and samples.',
  ...
  },
  {
    ...
    desc: '3D polyresin souvenir magnets and tinplate button magnets for collectible, souvenir and character-led merchandise programs.',
    seoTitle: '3D Polyresin Souvenir Magnets | Tinplate Button Magnets',
    seoDescription: 'Source 3D Polyresin Souvenir Magnets from a Tinplate Button Magnets Manufacturer. Request custom molds, packaging and wholesale lead time.',
    seoH1: '3D Polyresin & Tinplate Souvenir Magnets',
    count: 2,
    color: 'c-cream'
  },
  {
    ...
    desc: 'Custom magnetic dry-erase boards, fridge magnetic monthly planners and educational magnetic sheets for private-label programs.',
    seoTitle: 'Custom Magnetic Dry-Erase Boards | Monthly Planners',
    seoDescription: 'Source Custom Magnetic Dry-Erase Boards, Fridge Magnetic Monthly Planners and Educational Magnetic Sheets for private-label programs. Request a factory-direct quote.',
    seoH1: 'Custom Magnetic Stationery & Educational Products',
    count: 3,
    color: 'c-coffee'
  },
  {
    slug: 'all',
    name: 'All Products',
    desc: 'Explore custom flexible magnets, rubber magnets and magnetic media across five product series for global OEM/ODM programs.',
    seoTitle: 'Custom Magnets Manufacturer | Flexible & Rubber Magnetic Products',
    seoDescription: 'Explore custom magnets, flexible magnetic media, rubber magnets and OEM products for retail, advertising, education and industrial applications. Request a quote.',
    seoH1: 'Custom Magnets for Global B2B Buyers',
    count: 16,
    color: 'c-cream'
  }
];
